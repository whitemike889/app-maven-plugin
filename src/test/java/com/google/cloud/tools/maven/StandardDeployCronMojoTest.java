...
public class StandardDeployCronMojoTest {
  ...
  private SingleYamlStandardDeployTestHelper<DeployCronMojo> testFixture =
  ...
  @Test
  @Parameters({"jar", "war"})
  public void testDeploy(String packaging) throws MojoExecutionException, AppEngineException {
